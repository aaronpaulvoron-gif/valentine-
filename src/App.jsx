...
export default function App() {
  ...
  // STICKER REPLACEMENTS (High Reliability)
  const typingCat = "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExMmo0cW93ZzRnd29nNndnNndnNndnNndnNndnNndnNndnNndnJmYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/C1asB6XJjAnS0/giphy.gif";
  const successSticker = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHUxd2Z6YXo1Z3p6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/MDJ9IbM3vuzY2qEqaS/giphy.gif";
  const celebrationSticker = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNndnNndnNndnNndnNndnNndnNndnNndnNndnNndnNndnJmYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/ICOgUN76vCifu/giphy.gif";
  const sendSticker = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/m6OAdJ5T1kK3F8L3rS/giphy.gif";

  const [currentGif, setCurrentGif] = useState(typingCat);

  // --- 150 QUOTES (STAYING THE SAME) ---
  const kiligQuotes = [
  ...
  const sadStickers = [
    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueG56YXo1Z3p6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/OPU6wUKARA8AU/giphy.gif",
    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueG56YXo1Z3p6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/mlvseq9nOe4QXCLXdM/giphy.gif",
    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueG56YXo1Z3p6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/vFKqnCdLPNOKcAAC/giphy.gif"
  ];
  ...
  const handleResponse = async (isYes) => {
    ...
    if (isYes) {
      setAnswered(true);
      setQuote(finalQuote);
      setCurrentGif(successSticker);
      confetti({ particleCount: 150, spread: 70, origin: { y: 0.6 } });
    } else {
      setFinalNo(true);
      setQuote(finalQuote);
      setCurrentGif("https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueG56YXo1Z3p6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/AauJW0fL3p9E4/giphy.gif");
    }
  };
      ...
      <div style={styles.card}>
        {isResultView ? (
          <div>
            ...
            <img src={resultStatus === "yes" ? celebrationSticker : "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueG56YXo1Z3p6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6YXp6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/AauJW0fL3p9E4/giphy.gif"} style={styles.gif} />
            <h2 style={{color: '#333'}}>{recipientName}'s Response</h2>
            <p style={styles.finalQuote}>"{quote}"</p>
            <button onClick={() => window.location.href = window.location.origin} style={styles.backBtn}>← Back to Start</button>
          </div>
        ) : !recipientName ? (
          !submitted ? (
            <>
              <h1 style={styles.title}>Valentine 2026 💌</h1>
              <img src={typingCat} style={styles.gif} />
            ...
            <>
              ...
              <img src={sendSticker} style={styles.gif} />
          ...
          <>
            ...
            {!answered && !finalNo ? (
                  ...
                  <button
                    onClick={() => {
                      if (noCount < 10) {
                        ...
                        setCurrentGif(sadStickers[noCount % sadStickers.length]);
              ...
              <div style={styles.responseBox}>
                <p style={styles.stepTitle}>Send this back to your admirer!</p>
                <div style={styles.linkBox}>
...
const styles = {
  ...
  card: { background: "rgba(255, 255, 255, 0.95)", padding: "25px", borderRadius: "30px", boxShadow: "0 20px 50px rgba(0,0,0,0.15)", textAlign: "center", maxWidth: "400px", width: "85%", border: '2px solid white' },
  title: { color: "#ff4d6d", fontSize: "1.5rem", fontWeight: 'bold', marginBottom: '10px' },
  gif: { width: "100%", height: "160px", objectFit: "contain", marginBottom: "15px" },
  ...
  quoteDisplay: { color: "#ff4d6d", fontStyle: "italic", margin: "10px 0", fontSize: '0.85rem', minHeight: '30px' },
  waitMsg: { fontSize: '0.7rem', color: '#666', marginTop: '10px' },
  finalQuote: { fontSize: '0.9rem', color: '#ff4d6d', margin: '10px 0', fontWeight: 'bold' },
  stepTitle: { fontWeight: 'bold', fontSize: '0.8rem', marginBottom: '10px', color: '#333' },
  proposalText: { fontSize: '1rem', fontWeight: 'bold', marginBottom: '5px' }
};